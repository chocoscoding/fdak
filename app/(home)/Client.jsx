            ...
            {!hideButtons && (
              <>
                <div
                  ...
                  className="absolute w-8 h-8 minlg:w-12 minlg:h-12 top-45 cursor-pointer left-0 backdrop-blur rounded-full overflow-hidden">
                  <Image
                    src={images.left}
                    layout="fill"
                    objectFit="contain"
                ...
                <div
                  ...
                  className="absolute w-8 h-8 minlg:w-12 minlg:h-12 top-45 cursor-pointer right-0 backdrop-blur rounded-full overflow-hidden">
                  <Image
                    src={images.right}
                    layout="fill"
                    objectFit="contain"
